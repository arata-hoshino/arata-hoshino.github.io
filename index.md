...
subtitle: "A Civilizational Thesis on<br>Energy Abundance, Physical Automation,<br>and the Distribution of Ownership"
authors:
  - name: "Arata Hoshino"
...
function. The constraint that has bound our capacity to conceive large-scale investment comes
...
1. The industrial revolutions are read as two axes: the efficiency of the joule and the
   efficiency of the bit.
2. The supply constraint is argued to be suppressing, at the macro layer, our capacity to
...
and institutions, and forecasts the composition of the world at the level of clusters. It
concludes by identifying Texas and the UAE as the candidates for long and sustained success, the
...
<h3 class="toc-part">Part II · Diagnosis of the constraint</h3>
...
<h3 class="toc-part">Part IV · The map</h3>
