---
title: "Everything is energy conversion"
number: "1"
order: 2
part: "Part I. The physics of civilization"
summary: "A civilization's competitiveness is the product of institutions, the effective abundance of energy, and labour input. What that product settles is not wealth but what can be built from nothing, and what can be conceived at all. Britain in the 1840s and the UAE today. Windows open, and they also close. Stagnation, prices, distribution, and births are symptoms of one constraint."
---
...
Everything in this world is a conversion of energy. Cars, calculators, computers, aircraft, VR
headsets, and the computing systems that drive them. All of it rests on heat turned into
electricity, on electricity turned into hydrogen, or on fossil fuels, which are plant carbon
formed by photosynthesis and buried. Buckminster Fuller, in *Operating Manual for Spaceship
Earth* (1969), treated fossil fuels as a store loaded aboard the ship and warned against a
civilization that keeps funding its daily voyage out of that savings account. Sunlight, and the
...
assembling is fixed there now in the shape of a desk. Industrial ecology calls this embodied
...
One term of this thesis is settled here. Energy means a way of getting work done without
spending human hands. Buying that with coal and buying it with machines are the same purchase.
But a machine without electricity does not run, and energy without machines still needs hands,
...
What this thesis treats is the competitiveness of a civilization. Competitiveness here means how
fast it can build the next physical substrate and how much new investment at scale it can
execute. Quality, meaning the goodness of life for the people living there, is not treated.
...
**Institutions I.** That returns are preserved by private property rights, investor protection,
tax treatment, and the speed of permitting. That calls in capital. And an environment in which
failure is permitted and in which there is social inclusion. That calls in people. Neither is
competitiveness in itself. Both act as coefficients. What does the building is the capital and
the people who arrive.

**Effective energy abundance E.** Whether a society has access to a source of energy that is
effectively free, of the kind British coal was in the 1840s. And whether that state, in which
price can be largely ignored, is believed to persist partway through an asset's life. The
...
<p class="equation"><b>L</b> ≈ Technology access <b>T</b> × Large capital <b>K</b></p>
...
what it lacks arrives through alliance. China holds much of T and much of K but sits outside the
alliance. For a country with neither, two paths remain: accept enormous investment through
alliance, or receive a transfer of technology. L can be obtained without building it yourself.
It just requires somebody's permission.

### What this equation settles and what it does not

Let me be exact about scope. What this equation settles is not wealth as a stock but the
capacity to build as a flow.

The set of countries that are wealthy now and the set that can build now are different sets. The
first is running on inventory laid down in a period when all three were present. A society with
institutions but without abundance is wealthy and cannot build. The next section watches the
window open and close over a single country.

What the absence of abundance takes away is not prosperity in general but the option to build.
Steel mills, chemical plants, gigawatt-scale computing substrate, and cities themselves fall out
of the set of things that society can choose. And for the coming decades what the world needs is
the building, not the inventory.

Options, moreover, are not considered and rejected. They stop being proposed. Where it is known
that a premise will not move, no business plan is written on that premise, nothing reaches an
investment committee, and nothing is conceived in the first place. Let a constraint persist long
enough and the inside of the constraint starts to look like the whole world. The range of
ventures we currently feel to be realistic, and our common sense about the scale of investment,
were both built on the assumption that the three terms sit where they now sit. What this
equation binds is not only what can be built. It is what can be conceived.

How much of this structure belongs to prior literature is set out in "Objections and Limits" at
the end of this chapter.

## 1.3 Abundance and capital expenditure: what a civilization can build from nothing

Let me put the previous section's equation against history. The question is not whether an
existing factory turns a profit but the capacity to create stock from scratch.
...
Only a society with all three at once can build a rail network, a future city, or gigawatt-scale
computing substrate from nothing. The utility-cost argument asks whether an existing factory is
in the black. The abundance argument asks who can build the next civilization's stock. They are
...
meaning of the bet on physical AI and energy.

One thread, laid last. A society of abundance also reproduces its population. What drove the
...
throttles births through the price system is the path this thesis follows from here.
...
What is settled is not the thickness of the inventory but what can be built from here. And what
cannot be built falls out of the option set and then, in time, stops being conceived.

But the capacity to build does not stop there. What can be built determines what becomes cheap.
The price of what did not become cheap becomes the household's constraint. That order does not
run backwards.

Let me settle one thing about how to read this thesis. Stagnation, rising prices, the failure of
distribution, and falling births have each been argued as separate problems. This thesis reads
them as multiple symptoms produced by one constraint. The prescription is therefore not one per
symptom but one in total: fill whichever of the three terms is missing. Symptom-by-symptom
measures did not fail because they were badly designed. They failed because we were firing at
symptoms in the belief that they were causes.

Births, for which a thread was laid in the previous section, are the slowest-moving of those
symptoms. That is why they bite last and are hardest to take back. This thesis gives population
a large place not because raising it is the objective, but because whether the constraint has
come off shows up there last of all.

From here I follow, in order, where this system jams and what happens when the jam is cleared:
the process by which conversion was throttled, the path by which its cost descends to the
...
History and Energy" gives 60 gigajoules on a commercial-energy basis; the two series must not be
conflated.** The figure of roughly 300 watts including fire is my own estimate, adding to food
intake the burning of one kilogram of wood per person per day at 16 megajoules per kilogram; it
is not Smil's number. The 8,767 watts for the United States (2024) and the series in Figure 1-1
...
*Enterprise & Society* 8(3), 2007). Railway bill applications numbered 210 in the 1845 session
and 508 in 1846, roughly 720 in total, of which 121 and 272 passed, 393 in all (Esteves &
...
The body carries only the bones of the argument. Anticipated objections and how they are handled
are gathered here. Each heading indicates the passage in the body it corresponds to. No figures
are placed here.

### Why the equation takes this form (1.2)

There is a reason not to collapse it into a single efficiency term. Write competitiveness as
something like "energy times institutional efficiency" and everything unobservable ends up
inside the second term. That is the same structure as the Solow residual in growth accounting.
Moses Abramovitz called that residual "a measure of our ignorance" ("Resource and Output Trends
in the United States since 1870," *American Economic Review* 46(2), 1956, 5–23). An equation
that merely names a residual predicts nothing.
...
Capital and infrastructure are not placed as terms in order to avoid circularity. Capital is
what institutions and energy call in, and physical infrastructure is what gets built as the
product of the three. Line up the result on the side of the cause and the equation explains
itself. Defining the K in L ≈ T × K as a balance is for the same reason. What determines how
much can be built this period is capital accumulated through prior periods, not capital created
this period. That the result thickens the next period's balance is not denied. The opening and
closing of windows in 1.3 is exactly that circulation.

With that said, this equation should be read as an enumeration of necessary conditions rather
than a decomposition of causes. The claim is that if any one of the three is missing, nothing
gets built. It is not the claim that if all three are present, something necessarily does.

### How much of this structure belongs to prior literature (1.2)

The general form of "resources are not given but become resources through institutions" is
Zimmermann's functional theory of resources: resources are not, they become (Erich W.
Zimmermann, *World Resources and Industries*, Harper & Brothers, 1933; rev. ed. 1951,
pp.814–815). That resource dependence is an endogenous outcome of institutions is Brunnschweiler
and Bulte (*Journal of Environmental Economics and Management* 55(3), 2008, 248–264); the path
from cheap energy to automation and competitiveness is Allen (Robert C. Allen, *The British
Industrial Revolution in Global Perspective*, Cambridge University Press, 2009); the causal
identification of failures of conversion is Allcott et al. (*American Economic Review* 106(3),
2016, 587–624). The view that technological chokepoints open and close according to alliance and
network position is Farrell and Newman (*International Security* 44(1), 2019, 42–79).

The difference here is one point. The existing literature places institutions as a moderator;
this thesis places institutions on the side that calls in capital and talent, which are the
mediating variables. That is a choice of formulation rather than a discovery, and it is very
nearly the whole of what this thesis can claim as its own. Writing institutions as two
functions, the preservation of returns and the attraction of talent, follows Acemoglu and
Johnson, who separated property rights institutions from contracting institutions and concluded
that what matters for long-run growth and investment is the former, not the latter (Daron
Acemoglu & Simon Johnson, "Unbundling Institutions," *Journal of Political Economy* 113(5),
2005, 949–995).

**Zimmermann is cited via a citation database and the pages of the original have not been
...
equation.** And the decomposition L ≈ T × K applies only to the present; Britain in the 1840s
had neither technology access nor large capital.

This thesis puts the two into the same term because L is taken broadly, as input for getting
...
Section 1.2 says the constraint binds not only what can be built but what can be conceived.
**That claim, by its nature, cannot be directly observed.** The distribution of business plans
that were never written is recorded nowhere.

There are two indirect supports. The first is the discontinuous turnover in the objects of
investment immediately after a constraint loosens. Railways in 1840s Britain and computing
substrate in the 2020s Gulf both saw an asset class of a scale that had not previously existed
stand up within a few years of the loosening. The second is that in other countries of the same
period, where the same technology was known, investment at the same scale did not occur.
Availability of technology does not explain it; it has to be read as a difference on the side of
the premises.

**But these two are suggestive, not probative.** Since there is no way to observe the
counterfactual, this is the hardest claim in the thesis to test. It is marked as such.

### Are the three conditions only judgeable after the fact (1.3)

What the body offers are cases where all three were present and something was built, and cases
where one was missing and nothing was. It does not offer a case where all three were present and
nothing was built. Section 1.3 is therefore an illustration of the equation's application rather
than a test of it. What corresponds to a test is placed in the falsification table of the final
chapter.

### The direction of causation (1.2)

Correcting for type I error from overfitted VARs, no genuine causal effect from energy
consumption to growth is found across the literature as a whole; what is robustly detected is
only the direction from output to energy consumption (Stephan B. Bruns, Christian Gross & David
I. Stern, "Is There Really Granger Causality Between Energy Use and Output?" *The Energy
