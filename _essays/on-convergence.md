...
One limit of scope. What is treated here is only the direction of efficiency. The creation of value in a civilization has another axis entirely unrelated to productivity, one that produces culture and value out of waste. Festival, art, hospitality, play, expenditure. What happens on that axis once the two directions of efficiency have been fully automated is treated later in this thesis.
...
This is what the present turn actually is. The commitment of capital to physical AI and energy is not "the next trend." Of the two directions of the last twelve thousand years, it is capital's historical return to the side that was left behind.
...
The contents of the production function are being quietly replaced. Production was once the product of productivity and the working-age population, but as the human input thins, the productivity term is absorbed into the penetration of automation, and the production function converges asymptotically on the product of institutions, effective energy abundance, and labor input. There is no need to erect a new production function. The equation of Chapter 1 is itself the answer.
