...
Look back at the history. Coal, then oil, then natural gas: each time a new and more efficient source of energy was found and its cost brought down, the advanced countries turned round and set limits on their own use of it. The period from the beginning of the energy transition in the 1970s to the present may well have been a kind of transitional age. In it, the move off oil after the oil shock, environmental regulation, the shift to renewables, nuclear phase-out in some countries, and price management by OPEC+ all overlapped, the balance of energy supply and demand broke down in ways nobody intended, and energy prices ran for decades above the level that the available technology and the available resource base would otherwise have implied. In most advanced importing countries the cost of the energy transition ended up carried by households over a long horizon, the cost of living crept up faster than real wages, and disposable income was shaved away.
...
In the second half of that transitional age, the main exit the advanced countries chose was renewable energy. Let me set out the structural difficulty with renewables precisely. In one line: it swings in the opposite direction to human need.

There are four difficulties. It cannot be dispatched. Solar generates only in daylight, and wind rises and falls with the weather. A system that must match supply and demand instantaneously and continuously takes in a large volume of generation whose output nobody can command. That is a structural contradiction. It requires backup at all times. The higher the share, the more fast-responding plant has to be held on standby, ready to be brought up at any moment. That means owning the fleet twice over, which makes for a high-cost system running at low utilization. Surplus and shortage occur at the same time. In clear, windy conditions there is curtailment and there are negative prices; under cloud, in still air, at night, there is a large deficit. Past a certain share it destabilizes the grid as a whole. And its energy density is low. Output per unit of area is small, so it demands vast land and long transmission networks. It scales badly against exponential demand, in land and in grid alike.
...
There is a strange asymmetry of information here. Citizens, in asserting sustainability, impose an energy constraint on themselves, and do not notice that they are paying for it with every increase in the cost of their lives and every economic constraint upon them. They are unaware that the rope binding them is their own.
