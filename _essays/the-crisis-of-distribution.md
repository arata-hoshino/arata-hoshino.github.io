...
The conduit began to narrow before AI. On Karabarbounis and Neiman's well-known measurement,<sup class="noteref"><a href="#note-1">1</a></sup> the global labor share has fallen significantly since the early 1980s across the majority of countries and industries, and about half of that fall is explained by the falling relative price of investment goods, meaning machines and computation, and the substitution of capital for labor. On the theoretical side, Acemoglu and Restrepo's task-based model identified the mechanism.<sup class="noteref"><a href="#note-2">2</a></sup> The displacement effect of automation pushes labor out of tasks and always lowers the labor share. The only thing that can offset it is the reinstatement effect, the creation of new tasks for humans. In the United States of recent years, displacement accelerated and reinstatement weakened. On their estimate, 50 to 70 percent of the change in the American wage structure is explained by task displacement.<sup class="noteref"><a href="#note-2">2</a></sup>

So the problem sits here. The automation of tasks is not new; it has run continuously since the industrial revolution. In that revolution, cheap labor and cheap energy moved workers out of agriculture and into manufacturing. Human skill stayed adaptable and stayed meaningful. What is different in the age of AI is that automation can remove the need for human labor itself, not task by task but across whole categories of work: displacement goes general while there is no prospect of reinstatement. The problem is not AI's displacement of tasks. It is distribution. The problem is that once the tasks are automated, wealth stops being distributed. The new industrial revolution will be driven by cheap automated labor and cheap fusion energy. And when it arrives, the conduit of distribution will have vanished.

<figure class="figure">
  <img src="/assets/figures/figure-6-1.png" alt="Figure 6-1. The fall in the labor share (United States, 1975 to 2023). The American series is shown. The same downward trend is observed across most countries and industries .">
</figure>
...
What may be needed is an update to capitalism. The logic runs like this. If allocating income by contribution to tasks is dying, then move the ground of distribution from tasks to the ownership of capital. In a world where the labor share falls structurally, the only way for households to survive is for households to move over to the capital side. Make every citizen an investor.
...
**5. The leftward turn in politics.** On 4 November 2025, Zohran Mamdani won the New York mayoral election and Katie Wilson the Seattle mayoral election (final count of the New York City Board of Elections, certified 2 December 2025; Seattle was 50.2 percent to 49.5 percent, certified 25 November). On opinion, Jeffrey M. Jones, "Image of Capitalism Slips to 54% in U.S.," Gallup, 8 September 2025 (among all adults, 54 percent favorable to capitalism and 39 percent to socialism). **An earlier draft said that 49 percent of those aged 18 to 34 were favorable to socialism, above the 43 percent for capitalism, but that age-broken figure appears nowhere in Gallup's published material and has been withdrawn.**
{: #note-5 .note}
...
**9. The estimate on the downgrading side.** Daron Acemoglu, "The Simple Macroeconomics of AI," NBER WP 32487, 2024 (peer-reviewed version *Economic Policy* 40(121), 2025, 13–58). **The same paper simultaneously predicts a widening gap between capital income and labor income.**
{: #note-9 .note}
...
The OpenResearch and Finnish experiments are both about **transfers of limited duration**.<sup class="noteref"><a href="#note-8">8</a></sup> A transfer known to end in three years and capital income premised on lasting a lifetime do not mean the same thing to the behavior of the recipient. **The conclusion of this thesis, that a cheque does not move the structure, therefore reaches one step beyond what the experiments showed.** That step is, for now, an extrapolation by logic and not a demonstration.
